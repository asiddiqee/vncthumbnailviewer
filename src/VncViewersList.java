...
class VncViewersList extends Vector {
    ...
    if(prt == null || host == null) {
      ...
      if(success) {
        if(getViewer(host, port) == null) {
          VncViewer v = launchViewer(host, port, password, username, userdomain, tsname);
  ...
  public VncViewer launchViewer(String host, int port, String password, 
        String user, String userdomain, String tsname) {
  ...
  public static VncViewer launchViewer(VncThumbnailViewer tnviewer, String host, 
        int port, String password, String user, String userdomain, String tsname) {
