...
class ButtonPanel extends Panel implements ActionListener {
  ...
  ButtonPanel(VncViewer v) {
    ...
    /*=======
    disconnectButton = new Button("D");
    disconnectButton.setEnabled(false);
    add(disconnectButton);
    disconnectButton.addActionListener(this);

         
    optionsButton = new Button("Opts");
    add(optionsButton);
    optionsButton.addActionListener(this);
    
    clipboardButton = new Button("Clipb");
    ...
    refreshButton = new Button("Rfrsh");
    refreshButton.setEnabled(false);
    add(refreshButton);
    refreshButton.addActionListener(this);
 ======*/    
   
    //tsLabel = new JLabel ("  " + v.tsname);
    tsLabel = new JLabel ("  " + v.tsname + " (" + v.host + ")");
    tsLabel.setBackground(Color.cyan);
    tsLabel.setForeground(Color.blue);
    add(tsLabel);
