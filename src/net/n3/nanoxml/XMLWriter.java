...
public class XMLWriter
{
      ...
      throws IOException
   {
      ...
      if (xml.getName() == null) {
         ...
         Enumeration enumrr = xml.enumerateAttributeNames();

         while (enumrr.hasMoreElements()) {
            String key = (String) enumrr.nextElement();
         ...
         enumrr = xml.enumerateAttributeNames();
         ...
         if ((xml.getContent() != null)
            ...
            enumrr = xml.enumerateChildren();

            while (enumrr.hasMoreElements()) {
               IXMLElement child = (IXMLElement) enumrr.nextElement();
